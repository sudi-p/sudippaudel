...
const Hero = ({ handleClick}: HeroProps) => {
  return (
    <Section id="home">
        <div className="p-10 h-screen md:flex gap-32 justify-center items-center ">
          <div onClick={handleClick} className="p-2 group flex items-center gap-1 bg-blue-500 text-white rounded-xl cursor-pointer font-semibold hover:bg-blue-600 absolute top-10 right-0 md:right-28">
            <div className='group-hover:rotate-45'><FaHandPaper /></div>Say Hello!
          </div>
          <div className='flex flex-2 flex-col gap-5 md:gap-10 md:w-1/2'>
        ...
        <div className="relative">
          <div className="font-light leading-relaxed max-w-screen-xl m-auto tracking-wide p-4 text-center bg-blue-300 rounded-xl md:w-2/3 md:absolute inset-x-0 -top-[80px] bg-opacity-10 backdrop-blur-md border border-blue-300 shadow-md">
