...
export const portfolioProjects: PortfolioProjectItem[] = [
  {
    ...
    images: ['https://res.cloudinary.com/dtqxwjmwn/image/upload/v1772033356/sudippau/Shiboleth.png'],
  ...
  },
  {
    ...
    screenshotsAvailable: true,
    images: ['https://res.cloudinary.com/dtqxwjmwn/image/upload/v1772033356/sudippau/Best_sr.png'],
