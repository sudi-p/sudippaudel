  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto px-6 pb-24">
        ...
        {/* Interpersonal Communication Tab */}
        <div id="interpersonal" className="tab-content hidden">
          <div className="mb-8">
            <p className="text-slate max-w-2xl leading-relaxed">
              Learn how to{" "}
              <span className="font-semibold text-sapphire-dark">
              ...
              naturally in English — giving suggestions, making requests,
              explaining difficult situations, and more. Each category maps
              directly to CELPIP Speaking and Writing tasks, with vocabulary,
              intensity levels, common mistakes, and native-speaker fixes.
            </p>
          </div>
