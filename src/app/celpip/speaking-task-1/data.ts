...
export const TEMPLATE_PHRASES = [
  ...
  "To begin with, if I were you, I would",
  ", because",
  "Moreover,  you might want to",
  ", so",
  ", which",
...
export const SAMPLES = [
  {
    ...
    lines: [
      ...
      "To begin with, if I were you, I would update your resume to highlight transferable skills, because employers value what you've already learned.",
      "Moreover,  you might want to start networking in your new field by attending industry events or joining online communities, so you can hear about opportunities before you apply.",
      "Finally, I'd recommend taking an online course to build specific skills for the new career, which will boost your confidence and make you more competitive.",
  ...
  },
  {
    ...
    lines: [
      ...
      "To begin with, if I were you, I would create a priority list each morning, because it shows you which tasks matter most and stops you wasting energy on smaller things.",
      "Moreover,  you might want to block time for focused work without interruptions, maybe turning off email for an hour, so you finish tasks faster without being constantly distracted.",
      "Finally, I'd recommend talking to your manager about which tasks you can delegate or postpone, which will lighten your load since they might not realize you're overloaded.",
  ...
  },
  {
    ...
    lines: [
      ...
      "To begin with, if I were you, I would join one activity or club that interests you, like a sports team, book club, or volunteer group, because you'll meet people with shared interests.",
      "Moreover,  you might want to attend regularly and talk to the same people instead of just showing up once, so the bonds have time to develop naturally.",
      "Finally, I'd recommend hosting a small gathering or inviting someone for coffee, which will help because most people appreciate when someone takes the initiative.",
  ...
  },
  {
    ...
    lines: [
      ...
      "To begin with, if I were you, I would research beginner resources like YouTube tutorials, books, and community classes, because they help you avoid expensive mistakes and learn the basics safely.",
      "Moreover,  you might want to start with one affordable beginner kit rather than buying everything at once, so you can try it without a big investment.",
      "Finally, I'd recommend finding others doing the same hobby in online communities or local groups, which will keep you motivated since they can answer your questions.",
  ...
  },
  {
    ...
    lines: [
      ...
      "To begin with, if I were you, I would set a specific daily practice routine of even just 30 minutes, because consistency is what builds real progress.",
      "Moreover,  you might want to mix listening, speaking, reading, and writing instead of focusing on one skill, so all parts of the language reinforce each other.",
      "Finally, I'd recommend finding a conversation partner online or locally, which will build your confidence faster because you practise naturally rather than studying alone.",
